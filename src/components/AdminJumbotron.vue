    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
      ...
      >
        ...
        <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">
          Halaman ini digunakan untuk mengelola data yang ada seperti menambahkan data produk,
          menghapus data produk, mengedit data produk, menampilkan data produk dan lain sebagainya
        </p>
        <RouterLink
          to="/admin/products"
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">
            Panduan untuk mengelola data
          </h2>
          <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
            Di halaman ini anda dapat menambahkan data produk, mengedit data produk, menghapus data
            produk, menampilkan data produk dan lain sebagainya. untuk lebih detail silahkan baca
            paduan dibawah ini
          </p>
          <a
            href="#"
        ...
        >
          ...
          <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
            Dibuat oleh Ahmad Mufid Risqi pada tahun 2024 untuk mempermudah pengolahan data produk,
            menghitung total penjualan, serta memprint nota pembelian. untuk lebih detail silahkan
            baca tentang website dibawah ini
          </p>
          <a
            href="#"
            class="text-green-600 dark:text-green-500 hover:underline font-medium text-lg inline-flex items-center"
